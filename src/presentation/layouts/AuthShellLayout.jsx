export default function AuthShellLayout({ children }) {
  return (
    <div className="relative min-h-screen flex bg-gov-blue">
      ...
      <div className="hidden lg:block relative flex-1 w-full bg-gov-blue">
         <img src="/hero-press.png" alt="CMYK Offset Printing" className="absolute inset-0 h-full w-full object-cover opacity-80" />
         <div className="absolute inset-0 bg-gradient-to-l from-gov-blue via-gov-blue/60 to-gov-blue/10"></div>
